...
Query.prototype.getSelectQuery = function getSelectQuery(collection) {
  var self = this;
  var currentTable = _.find(_.values(self.schema), { tableName: collection }).identity;
  ...
  _query.params = _.reduce(_query.values[0], function(accumulator, value, index){
    ...
    var attribute = utils.getAttributeAsObject(self.schema[currentTable].attributes, key) || {};
    var foreignKeyOrId = key === '@rid' || key.indexOf('.@rid') !== -1 || 
