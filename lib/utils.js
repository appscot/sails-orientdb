...
var _ = require('lodash'),
    ...
    url = require('url'),
    log = require('debug-logger')('waterline-orientdb:utils');
 ...
 * @api public
 */
exports.reduceNestedObjects = function reduceNestedObjects(collection, callback, accumulator, rootKey, processedObjects) {
 ...
 * @api public
 */
exports.forEachNested = function forEachNested(collection, callback, processedObjects) {
  processedObjects = processedObjects || [];
  ...
  _.forEach(collection, function(value, key, parent) {
    if(_.isObject(value))
      return forEachNested(value, callback, processedObjects);
