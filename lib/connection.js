...
module.exports = (function () {
    ...
    */
    ...
    dbHelper.prototype.update = function (collection, options, values, cb) {
		...
		console.log('update _document.values: ' + require('util').inspect(_document.values));
    ...
    */
	...
	dbHelper.prototype.processMultilevelResults = function (results, joins){
		...
		console.log('rowMap: ' + require('util').inspect(rowMap));
		
		return _.filter(results, function(record){
			console.log('record: ' + require('util').inspect(record));
			return rowMap[record['id']].parent;
		});
	};
