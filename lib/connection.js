    ...
    var defaults = {
        ...
        DbHelper = function (db, collections, config) {
            ...
            Object.keys(collections).forEach(function(key) {
              context.newCollections[key] = new Collection(collections[key], context);
              console.log(context.newCollections[key].identity + ': ' + context.newCollections[key].superClass);
            });
        },
