                                            ...
                                            if (collection.attributes){
                                              ...
                                              Object.keys(collection.attributes).forEach(function(attributeName){
                                                ...
                                                if(attributeType){
                                                  ...
                                                  if(!!collection.attributes[attributeName].required || !!collection.attributes[attributeName].primaryKey) {
                                                    prop.mandatory = true;
                                                  }
                                                  klass.property.create(prop).then(function(){
                                                    if(!!collection.attributes[attributeName].unique || !!collection.attributes[attributeName].primaryKey){
                                                      db.index.create({
